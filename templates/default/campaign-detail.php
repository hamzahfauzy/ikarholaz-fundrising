<?php load_templates('layouts/default-top') ?>
    <div class="row mt-5">
        <div class="col-12 col-md-8">
            <img src="<?= base_url().'/'.$campaign->pic_url?>" alt="<?=$campaign->name?>" width="100%" class="mb-2">
            <div class="py-3">
        ...
        <div class="col col-md-4">
            <div class="card card-profile">
                ...
                <div class="card-footer">
                    <div class="row user-stats">
                        <div class="col">
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-info" role="progressbar" aria-valuenow="<?=$campaign->total_transaction->total?>" aria-valuemin="0" aria-valuemax="<?=$campaign->amount_target?>" style="width:<?=($campaign->total_transaction->total/$campaign->amount_target)*100?>%"></div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <a href="<?=routeTo('default/checkout',['type'=>'campaigns','id'=>$campaign->id],true)?>" class="btn btn-primary btn-block">DONASI SEKARANG</a>
                        </div>
                    </div>
                </div>
            </div>
